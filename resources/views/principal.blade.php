            ...
            <form id="form" method="POST" action="{{ route('login') }}">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="text-start">
                        ...
                        <a style="font-size: large; text-decoration: none; margin-left: 10px; font-weight: bold;" href="{{route('register')}}">Registrarse</a>
                    </div>

                    <x-primary-button class="btn_color" type="submit">
                        {{ __('Log in') }}
                    </x-primary-button>
                </div>
            </form>
