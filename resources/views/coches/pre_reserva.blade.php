            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="container py-5">
                    <div class="p-6 text-gray-900">
                        ...
                        <form class="d-block d-sm-flex mb-5 align-items-center mb-2" method="GET">
                            ...
                            <div class="col-12 mb-3">
                                <div class="card">
                                    <div class="card-body gap-5">
                                        <p class="card-text mb-1">Nombre<strong></strong></p>
                                        <p class="card-text mb-1">Apellidos<strong></strong></p>
                                        <p class="card-text mb-1">Coche<strong></strong></p>
                                        <p class="card-text mb-1">Parada<strong></strong></p>
                                        <p class="card-text mb-1">Tipo<strong></strong></p>
                                    </div>
                                </div>
                            </div>
                        </div>
